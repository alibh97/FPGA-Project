...
#endif
static const char *ng0 = "D:/darsi/fpga/Project/project/node.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
...
LAB28:    xsi_set_current_line(91, ng0);
    ...
    t55 = (t53 + 56U);
    t56 = *((char **)t55);
    xsi_vlog_generic_convert_bit_index(t54, t52, 2, t56, 32, 1);
    t57 = (t54 + 4);
...
LAB29:    xsi_vlogvar_assign_value(t31, t32, 0, *((unsigned int *)t54), 1);
    goto LAB30;
...
LAB39:    xsi_set_current_line(99, ng0);
    ...
    *((unsigned int *)t54) = (t43 & 15U);
    t44 = *((unsigned int *)t46);
    *((unsigned int *)t46) = (t44 & 15U);
    t55 = (t0 + 1208U);
    t56 = *((char **)t55);
    memset(t59, 0, 8);
    t55 = (t54 + 4);
...
LAB12:    xsi_vlog_unsigned_bit_combine(t3, 64, t20, 64, t26, 64);
    goto LAB16;
...
extern void work_m_00000000002906247195_0727293966_init()
{
	...
	xsi_register_didat("work_m_00000000002906247195_0727293966", "isim/t49_isim_beh.exe.sim/work/m_00000000002906247195_0727293966.didat");
